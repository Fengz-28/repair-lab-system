  ...
  return (
    <section className="relative overflow-hidden bg-zinc-950 text-white">
      ...
      <RepairContainer className="relative py-12 sm:py-16">
        <Link className="text-sm font-bold text-cyan-200 transition hover:text-white" href="/admin/customers">
          Volver a clientes
        </Link>
        <div className="mt-5 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-cyan-300">CRM / Cliente</p>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <RepairBadge tone="cyan">{ticketCount} tickets</RepairBadge>
          ...
          <RepairFloatingPanel className="w-full bg-zinc-900/45 lg:max-w-md">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-cyan-200">Resumen financiero</p>
