      ...
      <RepairContainer className="relative py-12 sm:py-16">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-cyan-300">Admin / Inventario</p>
            <h1 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">
              Catalogo e inventario
            </h1>
            <p className="mt-4 max-w-2xl text-sm leading-6 text-zinc-300 sm:text-base">
              Controla servicios, productos, repuestos y stock real del taller sin convertir la operacion interna en un ERP pesado.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <RepairBadge tone="cyan">{stats.totalItems} items</RepairBadge>
              <RepairBadge tone="cyan">{stats.trackedItems} con stock</RepairBadge>
              <RepairBadge tone={stats.lowStockItems > 0 ? "warning" : "cyan"}>
          ...
          <RepairFloatingPanel className="w-full bg-zinc-900/45 lg:max-w-md">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-cyan-200">Pulso de inventario</p>
